...
if len(df_date) == 0:
    ...
    with st.sidebar:
        st.warning('Here, the intensity in color represents negative sentiment in and around that particular area. These insights can be leveraged for improving custimer service \
